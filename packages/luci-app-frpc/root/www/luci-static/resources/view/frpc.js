...
const pageStyle = [
	...
	'.frpc-editor { box-sizing:border-box; width:100%; min-height:32rem; max-height:32rem; resize:vertical; font:12px/1.55 monospace; }',
